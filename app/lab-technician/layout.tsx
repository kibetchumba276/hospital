...
export default function LabTechnicianLayout({ children }: { children: React.ReactNode }) {
  ...
  async function checkUser() {
    ...
    try {
      ...
      if (userData?.role !== 'super_admin' && userData?.role !== 'lab_technician') {
        router.replace('/login')
        return
      }
      ...
      <header className="bg-white border-b sticky top-0 z-10">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          <div className="flex items-center gap-2">
            ...
            <span className="text-2xl font-bold text-primary-700">MediCare - Laboratory</span>
          </div>
          <div className="flex items-center gap-4">
            {user?.role === 'super_admin' && (
              ...
              >
                ...
                <option value="/lab-technician">Lab Technician Dashboard</option>
